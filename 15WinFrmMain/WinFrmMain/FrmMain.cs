...
namespace WinFrmMain
{
    public partial class FrmMain : Form
    {
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            ...
            //String.Format("{0}시 {1:0#}분 {2:0#}초", DateTime.Now.Hour, DateTime.Now.Minute, DateTime.Now.Second);
            String.Format("{0}시 {1:0#}분 {2}초", DateTime.Now.Hour, DateTime.Now.Minute, DateTime.Now.Second.ToString().PadLeft(2, '0'));
        }
